...
object FunctionalProgramming_3 extends App {
	...
	*/
	...
	// ALL SCALA FUNCTIONS ARE ARE INSTANCES OF THESE FUNCTION_X TYPES
	...
	// all the pairs between numbers 1, 2, 3 and the letters 'a', 'b', 'c'
