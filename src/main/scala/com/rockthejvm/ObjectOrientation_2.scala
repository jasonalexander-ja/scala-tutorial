...
object ObjectOrientation_2 extends App {
	...
	// constructor arguments are not fields: you need to put a val before the argument
	aDog.name
	...
	abstract class WalkingAnimal {
		val hasLegs = true // by default public, can restrict by using protected or private
		def Walk(): Unit
	}
	...
	class Crocodile extends Animal with Carnivore with Philosopher {
		...
		override def ?!(thought: String): Unit = println(s"I wasd thinking: $thought")
	}
	...
	/*
		...
		class Carnivore_Anonymous_234433 extends Carnivore {
			override def eat(animal: Animal): Unit = println("I am a dinosaur so I can eat pretty much anything")
		}
		val dinosaur = new Carnivore_Anonymous_234433
	*/
	
	// singleton object
	
	object MySingleton {// only instance of MySingleton type
		val mySpecialValue = 456435435
		def mySpecialMethod(): Unit = 233434
	...
	object Animal { // companions - companion object
		...
		// singleton Animal and instances animal are different things
	...
	// any modification to anm object must return ANOTHER object
	/*
		Benefits:
